  ...
  return (
    <div className={styles.Section}>
        <div className={styles.Header}>
            ...
            <div className={styles.Content}>Join a vibrant community of creators and collectors who share your passion for digital ownership.</div>
        </div>
        <div className={styles.Cards}>
            ...
            <div className={styles.Card1}>
                <img src="https://res.cloudinary.com/dkoxgwtku/image/upload/v1677942841/hitler_as_a_modern_hipster_evsecp.jpg" alt="Hitler" />
                <div className={styles.CardText}>
                    <div className={styles.CardHeading}>Hitler</div>
                    <div className={styles.CardSub}>History</div>
                    <div className={styles.CardOwner}>@Shikamaru_Saga</div>
                </div>
            </div>
            <div className={styles.Card1}>
                <img src="https://res.cloudinary.com/dkoxgwtku/image/upload/v1677942841/A_cute_adorable_baby_engineer_robot_made_of_crysta_zcel22.jpg" alt="Robot" />
                <div className={styles.CardText}>
            ...
            <div className={styles.Card1}>
                <img src="https://res.cloudinary.com/dkoxgwtku/image/upload/v1677942841/Cute_and_adorable_cartoon_goku_baby_gadofu.jpg" alt="Goku" />
                <div className={styles.CardText}>
